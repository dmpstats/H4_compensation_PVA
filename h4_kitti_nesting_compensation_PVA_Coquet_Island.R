#' =============================================================================================================
#' ~~ Purpose: NEPVA model for Kittiwakes in Coquet Island 
#'          
#' ~ Author: BARC
#' 
#' ~ Created: 14/05/2021
...
write_rds(migrants_wide, path = "../../outputs/nesting/pva_Coquet_Island_migrants.rds", 
          compress = "gz")
