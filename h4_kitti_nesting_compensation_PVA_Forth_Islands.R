#' =============================================================================================================
#' ~~ Purpose: NEPVA model for Kittiwakes in Forth Islands
#'          
#' ~ Author: BARC
#' 
#' ~ Created: 14/05/2021
...
bsln_immat_surv <- data.frame(Mean = c(0.790, 0.911, 0.911, 0.911), SD = c(0, 0.035, 0.035, 0.035)); bsln_immat_surv


# Baseline Adult Survival
bsln_adult_surv <- data.frame(Mean = 0.911, SD = 0.035); bsln_adult_surv
...
write_rds(migrants_wide, path = "outputs/nesting/pva_Forth_Islands_migrants.rds", 
          compress = "gz")
