#' =============================================================================================================
#' ~~ Purpose: NEPVA model for Kittiwakes in St Abb’s Head to Fast Castle 
#'          
#' ~ Author: BARC
#' 
#' ~ Created: 14/05/2021
...
spa_name <- "St Abb's Head to Fast Castle SPA"
...
write_rds(migrants_wide, path = "outputs/nesting/pva_stAbbsHead_FastCastle_migrants.rds", 
          compress = "gz")
