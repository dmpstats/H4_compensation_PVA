#' =============================================================================================================
#' ~~ Purpose: NEPVA model for Kittiwakes in Troup, Penn and Lion’s Heads
#'          
#' ~ Author: BARC
#' 
#' ~ Created: 14/05/2021
...
spa_name <- "Troup, Pennan and Lion's Heads SPA"
...
write_rds(migrants_wide, path = "outputs/nesting/pva_Troup_Pennan_Lions_Heads_migrants.rds", 
          compress = "gz")
