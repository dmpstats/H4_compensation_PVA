#' =============================================================================================================
#' ~~ Purpose: NEPVA model for Kittiwakes in Farne Islands
#'          
#' ~ Author: BARC
#' 
#' ~ Created: 14/05/2021
...
write_rds(migrants_wide, path = "../../outputs/nesting/pva_Farne_Islands_migrants.rds", 
          compress = "gz")
